...
var live = {
	setup: function(el, bind, unbind) {
		...
		removalDisposal = domMutate.onNodeRemoval(el, function () {
			...
			//IE11 dosen't support "contains" on "document"
			//and doc.documentElement is always "null" after using "ownerDocument" 
			if (!ownerNode && typeof document !== "undefined") {
				ownerNode = document.documentElement;
			}
